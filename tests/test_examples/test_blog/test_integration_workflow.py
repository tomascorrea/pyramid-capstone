...
def test_pagination_workflow(test_blog_app):
    ...
    author_data = {
        'username': 'prolific_author',
        'email': 'prolific@blog.com',
...
def test_filtering_workflow(test_blog_app):
    ...
    posts_data = [
        ...
        {'title': 'Lifestyle Post 1', 'author_id': author1['id'], 'category_id': lifestyle_category['id'], 'status': 'published'},
        {'title': 'Lifestyle Post 2', 'author_id': author2['id'], 'category_id': lifestyle_category['id'], 'status': 'published'},
    ]
